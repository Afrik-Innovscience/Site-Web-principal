<?php
/**
 * The base template for displaying layout-5 single posts.
 *
 * @package Techguide
 */
...
get_header( techguide_template_base() ); ?>
	...
	<?php techguide_get_template_part( 'template-parts/post/single-layout-5/single-feature-header', get_post_format() ) ?>
