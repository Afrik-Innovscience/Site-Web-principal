<?php
/**
 * The base template for displaying layout-4 single posts.
 *
 * @package Techguide
 */
...
get_header( techguide_template_base() ); ?>
	...
	<?php techguide_get_template_part( 'template-parts/post/single-layout-4/single-feature-header', get_post_format() ) ?>
