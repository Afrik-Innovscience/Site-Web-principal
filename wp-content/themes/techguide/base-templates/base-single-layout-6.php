<?php
/**
 * The base template for displaying layout-6 single posts.
 *
 * @package Techguide
 */
...
<?php techguide_site_breadcrumbs(); ?>
	...
	<div <?php techguide_content_wrap_class(); ?>>
		...
		<?php techguide_get_template_part( 'template-parts/post/single-layout-6/single-feature-header', get_post_format() ) ?>
