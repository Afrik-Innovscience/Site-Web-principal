...
if ( ! class_exists( 'Techguide_Widget_Area' ) ) {

	/**
	 * Class Techguide_Widget_Area.
	 */
	class Techguide_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'techguide_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'techguide_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'techguide_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function techguide_widget_area() {
		return Techguide_Widget_Area::get_instance();
	}

	techguide_widget_area();
}
