( function( $, data ) {
	...
	var techguideElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, techguideElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, techguideElementor.initCb );
		},
	...
	techguideElementor.init();

}( jQuery, window.techguideEditData ) );
